...
CREATE TABLE IF NOT EXISTS eml_EmailAddr(
  ...
  FName VARCHAR(20) NOT CHARACTER SET utf8 NULL COMMENT '姓名',
...
CREATE TABLE IF NOT EXISTS eml_Task(
  ...
  FContentFile VARCHAR(30) NOT NULL CHARACTER SET utf8 COMMENT '发送内容文件',
  PRIMARY KEY (FKey)
);
...
CREATE TABLE IF NOT EXISTS eml_TaskRecvList_Template(
  ...
  FDoneDate DATETIME NOT NULL COMMENT '任务完成时间', 
